...
class Builder:
    ...
    def writerepo(self, name, version, release, OS, arch):
        ...
        if OS == "redhat" and self.config.needsComps():
            ...
            cmd.append(os.path.join(basedir, "RedHat/base/comps.xml"))
        cmd.append(".")
        subprocess.call(cmd)
...
class RollBuilder(Builder, stack.dist.Arch):
    ...
    def addComps(self, basedir):
        ...
        foundation_comps = os.path.join(
            ...
            sarch,
            "RPMS",
            "foundation-comps-%s-%s.noarch.rpm" % (sversion, srelease),
        )
